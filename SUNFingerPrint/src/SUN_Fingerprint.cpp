...
#define GET_CMD_PACKET(...)                                                    \
  ...
  SUN_Fingerprint_Packet packet(FINGERPRINT_COMMANDPACKET, sizeof(data),  \
                                     data);                                    \
...
*/
/**************************************************************************/
SUN_Fingerprint::SUN_Fingerprint(SoftwareSerial *ss,
                                           uint32_t password) {
...
*/
/**************************************************************************/
SUN_Fingerprint::SUN_Fingerprint(HardwareSerial *hs,
                                           uint32_t password) {
  thePassword = password;
  theAddress = 0xFFFFFFFF;
...
SUN_Fingerprint::SUN_Fingerprint(Stream *serial, uint32_t password) {
...
*/
/**************************************************************************/
void SUN_Fingerprint::begin(uint32_t baudrate) {
...
*/
/**************************************************************************/
boolean SUN_Fingerprint::verifyPassword(void) {
  return checkPassword() == FINGERPRINT_OK;
}

uint8_t SUN_Fingerprint::checkPassword(void) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::getParameters(void) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::getImage(void) {
...
/*!
   ...
   fingerprint features
*/
uint8_t SUN_Fingerprint::image2Tz(uint8_t slot) {
...
*/
uint8_t SUN_Fingerprint::createModel(void) {
...
/*!
   ...
   to flash memory
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t SUN_Fingerprint::storeModel(uint16_t location) {
...
/*!
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t SUN_Fingerprint::loadModel(uint16_t location) {
...
/*!
   ...
   buffer to the UART
    ...
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t SUN_Fingerprint::getModel(void) {
...
/*!
   ...
   to flash memory
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t SUN_Fingerprint::deleteModel(uint16_t location) {
...
/*!
   ...
   to flash memory
    @returns <code>FINGERPRINT_PACKETRECIEVEERR</code> on communication error
*/
uint8_t SUN_Fingerprint::emptyDatabase(void) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::fingerFastSearch(void) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::LEDcontrol(bool on) {
  if (on) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::LEDcontrol(uint8_t control, uint8_t speed,
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::fingerSearch(uint8_t slot) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::getTemplateCount(void) {
...
*/
/**************************************************************************/
uint8_t SUN_Fingerprint::setPassword(uint32_t password) {
...
void SUN_Fingerprint::writeStructuredPacket(
    const SUN_Fingerprint_Packet &packet) {
...
/**************************************************************************/
uint8_t
SUN_Fingerprint::getStructuredPacket(SUN_Fingerprint_Packet *packet,
                                          uint16_t timeout) {
  uint8_t byte;
